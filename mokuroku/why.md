...
|SHIBUYA-Begriff|Was es wirklich ist|Warum wir es so nennen|
|:---|:---|:---|
|MOKUROKU (Katalog)|Projekt-Dokumentation|"Doku" klingt nach Arbeit, Katalog nach Ordnung.|
|BUGYO (Verwalter)|ScrumMaster / PL|Trennt die Rolle von der "Jira-Verwaltung".|
|METSUKE (Inspektor)|Tester / QA|Ein Inspektor prüft Qualität, ein Tester sucht nur Fehler.|
|SHOGUN|Admin|System Governance / Architect|
|SAMURAI|Developer|Core Developer / Implementation|
|HATAMOTO|DevOps|Infrastruktur, CI/CD, Automatisierung|
|SUIDO|Port Management|Beschreibt nur die Ports im Entwicklungssystem|
